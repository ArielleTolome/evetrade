...
const navItems = [
  ...
  { path: '/market-orders', label: 'Market Orders', icon: '🛒' },
  { path: '/trade-profits', label: 'Trade Profits', icon: '💰' },
  ...
  { path: '/market-velocity', label: 'Velocity', icon: '⚡' },
  { path: '/contracts', label: 'Contracts', icon: '📜' },
  { path: '/industry-profits', label: 'Industry', icon: '🏭' },
  { path: '/lp-optimizer', label: 'LP Store', icon: '🎖️' },
  { path: '/pi-optimizer', label: 'PI Optimizer', icon: '🪐' },
  { path: '/corp-orders', label: 'Corp Orders', icon: '🏢' },
  { path: '/smart-route', label: 'Smart Route', icon: '🗺️' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            {navItems.slice(0, 8).map(({ path, label }) => (
              <Link
                key={path}
                to={path}
                className={`
